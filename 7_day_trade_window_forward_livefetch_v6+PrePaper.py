...
def main():
    ...
    print("\n" + "=" * 100)
    print(f"[DEBUG] pair={pair!r} run_mode_raw={run_mode_raw!r} run_mode={run_mode!r} AUTO_TOP_N_env={os.getenv('AUTO_TOP_N')!r}")
    print(f"[DEBUG] CANDIDATE_TRADE_JSON={os.getenv('CANDIDATE_TRADE_JSON', 'candidate_for_TRADE.json')!r}")
    ...
    if run_mode == "AUTO_CYCLE":
        ...
        print(f"[AUTO_CYCLE] finalists={len(finalists)} AUTO_TOP_N={AUTO_TOP_N} cycle={[f['possibility'] for f in cycle]}")
